		...
		<div class="wrapper">
			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<form class="login active" id="loginForm"  action="${rootPath}/user/login" method="post">
						<h3>Login</h3>
						<div>
							<label>Username:</label>
						...
						<div class="bottom">
							...
							<input type="submit"  onclick="return userLoginSubmit()" value="Login"/>
					...
					<form class="forgot_password">
						...
						<div class="bottom">
							...
							<a href="${rootPath}/user/login" rel="login" class="linkform">Suddenly remebered? Log in here</a>
							<a href="${rootPath}/user/register" rel="register" class="linkform">You don't have an account? Register here</a>
							<div class="clear"></div>
						</div>
					</form>
				</div>
